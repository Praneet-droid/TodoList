...
function AddTodo({userTodos,handleDeleteTodo}) {
          ...
          <div key={todo.id}>
            <div className="relative mt-2 rounded-md shadow-sm">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center">
                <button onClick={()=>(handleEditTodo(todo))} type="button" className="btn btn-warning p-0.5">
                  <FaEdit /></button>
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              ...
              />
              <div className="absolute inset-y-0 right-0 flex items-center">
              <button onClick={()=>editCompleted(todo.id)}
